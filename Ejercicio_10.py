...
for temperatura in temperaturas:
    ...
    print(f'la suma de las temperaturas es: {temperaturas}')

cantidad_temperaturas = len(temperaturas)
print(f'la cantidad de temp es : {cantidad_temperaturas}')
...
print(f' La temperatura maxi es: {temperatura_max}')
print(f'LLa termperatura min es : {temperatura_min}')
